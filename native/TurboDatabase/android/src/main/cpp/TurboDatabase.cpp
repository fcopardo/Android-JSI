...
Java_com_ursusarctos_db_JNIDatamanager_installBinding(JNIEnv *env, jobject thiz, jlong runtimePtr)
{
  ...
  auto clazz = env->FindClass("com/ursusarctos/db/JNIDatamanager");
...
{
  auto testModuleName = "TurboDatabase";
    ...
    const jsi::PropNameID &name)
{
  ...
  return jsi::Function::createFromHostFunction(
          ...
          [](
            ...
            auto valId = env->GetStaticMethodID(globalClassRef, "getCount", "()Ljava/lang/Integer;");
